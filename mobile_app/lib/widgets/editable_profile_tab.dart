...
class _ProfileEditSheetState extends State<_ProfileEditSheet> {
    ...
    setState(() {
      ...
      switch (target) {
        case 'vehicle':
          ...
          break;
        case 'national_id':
          _pickedNationalId = file;
          break;
        case 'driving_license':
          _pickedDrivingLicense = file;
          break;
        case 'store_logo':
          _pickedStoreLogo = file;
          break;
        default:
          _pickedProfile = file;
      }
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              onTap: () {
                Navigator.pop(ctx);
                _pickImage(ImageSource.camera, target: target);
              },
            ),
            ListTile(
              leading: Icon(
              ...
              onTap: () {
                Navigator.pop(ctx);
                _pickImage(ImageSource.gallery, target: target);
              },
            ),
          ],
        ),
  ...
  Future<void> _pickLocation() async {
    ...
    if (perm == LocationPermission.denied ||
      ...
      if (mounted) {
        showAppSnack(context, 'Permission refusée', type: MessageType.error);
      }
      return;
    }
  ...
  String _parseApiError(String raw) {
    ...
    if (idx >= 0) {
      try {
        final decoded =
            jsonDecode(raw.substring(idx + 2)) as Map<String, dynamic>;
        final lines = <String>[];
            ...
            children: [
              ...
              if (isVendor) ...[
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField<String>(
                    initialValue:
                        shopCategories.any((c) => c.id == _storeType.text)
                        ? _storeType.text
                        : null,
                    decoration: InputDecoration(
                ...
                _imagePicker(
                  label: 'Ajouter logo',
                  picked: _pickedStoreLogo,
                  existingPath: u.storeLogo,
                  target: 'store_logo',
                ),
                ...
                const SizedBox(height: 8),
                _imagePicker(
                  label: 'Ajouter carte nationale',
                  picked: _pickedNationalId,
                  existingPath: u.nationalId,
                  target: 'national_id',
                ),
                const SizedBox(height: 14),
              ],
              ...
              if (isDriver) ...[
                ...
                _imagePicker(
                  ...
                  picked: _pickedProfile,
                  existingPath: u.profileImage,
                  target: 'profile',
                ),
                const SizedBox(height: 14),
                ...
                _imagePicker(
                  ...
                  picked: _pickedDrivingLicense,
                  existingPath: u.drivingLicense,
                ...
                const SizedBox(height: 8),
                _imagePicker(
                  label: 'Ajouter photo du véhicule',
                  picked: _pickedVehicle,
                  existingPath: u.vehicleImage,
                  target: 'vehicle',
                ),
                const SizedBox(height: 14),
              ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 13,
                        color: hasCoords ? Colors.black : Colors.grey,
                        fontWeight: FontWeight.w600,
                      ),
                    ),
